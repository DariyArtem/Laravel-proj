...
Route::get('/about', [PagesController::class, 'aboutPage'])->name('about')->middleware(LogMiddleware::class);
...
Route::get('/author/{id}', [PagesController::class, 'authorPage'])->name('author')->middleware(LogMiddleware::class);
...
Route::view('recovery', 'pages.passwordRecovery')->name('recovery');
